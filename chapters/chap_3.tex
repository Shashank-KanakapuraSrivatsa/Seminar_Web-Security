...
\textbf{Note : }In all the further examples we consider, the colour of the requests(\textcolor{mygreen}{Green}, \textcolor{myred}{Red} and \textcolor{myorange}{Orange}) in figure \ref{fig:HTTP Desync Attack} will corresspond to the color of the text in the examples. 
\begin{figure}
