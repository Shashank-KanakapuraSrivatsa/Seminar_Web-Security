...
Consider another example for \textbf{TE.CL} in figure \ref{fig:TE.CL}. In this request \textcolor{mygreen}{0} is explicitly placed to force the server into considering it as the \textit{terminating chunk}.
\begin{figure}
