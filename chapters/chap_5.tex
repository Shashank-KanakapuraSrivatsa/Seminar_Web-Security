...
Many of the websites use several layers of CDNs \cite{b12} and reverse proxies \cite{b13}. Even though it is difficult to attack such websites due to multiple tightly coupled layers, this setup also gives increased opportunities for desynchronization and request smuggling.
